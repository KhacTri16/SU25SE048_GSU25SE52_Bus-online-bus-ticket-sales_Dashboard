...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Địa điểm",
    subItems: [
      { name: "Danh sách địa điểm", path: "/locations", pro: false },
    ],
  },
  {
    icon: <UserCircleIcon />,
...
const AppSidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`fixed mt-16 flex flex-col lg:mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-700 text-gray-900 dark:text-white h-screen transition-all duration-300 ease-in-out z-50 border-r border-gray-200 dark:border-gray-700 
        ${
